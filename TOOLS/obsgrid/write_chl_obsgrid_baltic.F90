...
program rmse
  ...
  integer :: i, j, i_index, j_index, counter, step, mcnt, cnt_days, cnt, cnt0, cntmin
...
! *** set first timer ***
  ...
  mloop: do mcnt = 1, nmonths
     ...
     !call check( nf90_inq_varid(oncid, "adjusted_sea_surface_temperature", varid_o) )
