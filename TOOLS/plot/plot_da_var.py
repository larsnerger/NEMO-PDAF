...
#    minmax = [260.0,450.0]      # max/max plotted values - set min=max for automatic
    ...
    if coupled=='':
        ...
        dotcoupled='.'+coupled
    data_coarse, coarse_keys = read_model_var(varstr, 'coarse', year, month, day, ampm, depth, DAtype, dotcoupled, z_mean, z_integral, z1, z2)
...
#    strcmap = 'gist_ncar_r'
    ...
    elif varnum==23:     # Chlorophyll
        strcmap = cmocean.cm.phase
        strcmap = 'gist_ncar_r'
