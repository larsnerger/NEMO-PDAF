...
if __name__ == "__main__":
    ...
    varnum_range = [2, 3, 6, 7, 8, 9, 10, 11, 12, 13, 14, 16, 21, 23, 24] 	
    ...
    for varnum in varnum_range:
      ...
      field_mean_list.append(np.nanmean(std_dev))     
    ...
    print 'MEAN over grid and time:' 
    for v in range(0,len(varstr_list)):
      print varstr_list[v], field_mean_list[v]
