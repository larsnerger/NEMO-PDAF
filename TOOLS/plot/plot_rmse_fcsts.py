...
experiment2 = 'fcst_initMarch1_N30'
experiment3 = 'fcst_initMay1_N30'
...
path_da2 = '/scratch/projects/hbk00095/exp/'+experiment2+'/rmse'
path_da3 = '/scratch/projects/hbk00095/exp/'+experiment3+'/rmse'

file_free = 'rms_'+var1+'_free_N30.nc';
file_da1 = 'rms_'+var1+'_'+experiment1+'.nc';
file_da2 = 'rms_'+var1+'_'+experiment2+'.nc';
file_da3 = 'rms_'+var1+'_'+experiment3+'.nc';
...
plt.plot(doy_da2[:], rmse_da2[0,:], 'g', label='Fcst '+var2)
#plt.plot(doy_da2[:], rmse_da2[1,:], 'r--', label='Ana '+var2)
plt.plot(doy_da3[:], rmse_da3[0,:], 'g', label='Fcst '+var2)
#plt.plot(doy_da2[:], rmse_da2[1,:], 'r--', label='Ana '+var2)
