...
!!
!! Observation type: CHL observations for the Baltic from CMEMS
!! 
...
!!
module mod_obs_chl_baltic_cmems_pdafomi
  ...
  logical :: assim_chl_baltic_cmems = .false.  !< Whether to assimilate this data type
  ...
  integer :: time_chl_baltic_cmems = 0         !< Time at which the daily observations are assimilated
                                        !< (0) mightnight, (12) noon
  character(len=3) :: dist_chl_baltic_cmems = 'geo'  ! Type of distance computation: 
...
!!
  subroutine init_dim_obs_chl_baltic_cmems(step, dim_obs)
...
! ********************
  ...
  end subroutine init_dim_obs_chl_baltic_cmems
...
!!
  subroutine obs_op_chl_baltic_cmems(dim_p, dim_obs, state_p, ostate)
...
! ******************************************************
  ...
  end subroutine obs_op_chl_baltic_cmems
...
!!
  subroutine init_dim_obs_l_chl_baltic_cmems(domain_p, step, dim_obs, dim_obs_l)
...
! **********************************************
    ...
    call PDAFomi_init_dim_obs_l(thisobs_l, thisobs, coords, &
         locweight, lradius_chl_baltic_cmems, sradius_chl_baltic_cmems, dim_obs_l)

  end subroutine init_dim_obs_l_chl_baltic_cmems
...
!!
  subroutine localize_covar_chl_baltic_cmems(dim_p, dim_obs, HP_p, HPH, coords_p)
...
! *************************************
    ...
    call PDAFomi_localize_covar(thisobs, dim_p, locweight, lradius_chl_baltic_cmems, sradius_chl_baltic_cmems, &
         coords_p, HP_p, HPH)

  end subroutine localize_covar_chl_baltic_cmems

end module mod_obs_chl_baltic_cmems_pdafomi
